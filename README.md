...
python extract_mesh.py --cfg configs/shape/nerf/refrac.yaml
```
...
python run_training.py --cfg configs/stage2/nerf/refrac.yaml
# estimate BRDF of the "lego" of the Blender dataset
python run_training.py --cfg configs/material/nerf/reflec.yaml
```
