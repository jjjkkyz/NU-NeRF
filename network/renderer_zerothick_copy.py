...
from network.field import SDFNetwork, SingleVarianceNetwork, NeRFNetwork, AppShadingNetwork, get_intersection, \
    extract_geometry, sample_pdf, AppShadingNetwork_S2, InfOutNetwork, IoRNetwork, ThicknessNetwork, AppShadingNetwork_DiffuseInner
...
class Stage2Renderer(nn.Module):
    ...
    def __init__(self, cfg, training=True):
       ...
       # self.infinity_far_bkgr = InfOutNetwork()
        ...
        mesh_path = '/home/sunjiamu/NeRO/data/meshes/ballstatue3-300000.ply'
      #  mesh_path = '/home/sunjiamu/NeRO/data/meshes/refrac_withexpref_complex_withadd4-491000.ply'
       ...
       # self.outer_nerf = self.stage1_network.outer_nerf
        ...
        self.color_network_inner = AppShadingNetwork_DiffuseInner(self.cfg['shader_config'])
      #  self.sdf_inter_fun = lambda x: self.sdf_network.sdf(x)
