...
import cv2 as cv
database = NeRFSyntheticDatabase('nerf/spherepot','./datasets')
...
scene = Scene('/media/jmsun/Storage/NU-NeRF/data/meshes/spherepot1-49000.ply')
for img_idx in range(imn):
    ...
    cv.imwrite('/media/jmsun/Storage/NU-NeRF/datasets/spherepot/mask_test/' + str(img_idx) + '.jpg',converged)
   # exit(1)
